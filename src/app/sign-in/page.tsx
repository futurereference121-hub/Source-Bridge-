    ...
    return (
      <div className="bg-background pt-28 pb-20">
        <Container className="max-w-lg text-center">
          <h1 className="text-4xl font-bold tracking-tight text-navy">Signed in</h1>
  ...
  return (
    <div className="bg-background pt-28 pb-20 sm:pt-32 sm:pb-28">
      <Container className="max-w-md">
        <h1 className="text-4xl font-bold tracking-tight text-navy">Sign in</h1>
        ...
        <p className="mt-6 text-sm text-muted">
          New here?{" "}
          <Link href="/join" className="text-electric underline-offset-2 hover:underline">
            Join Source Bridge
          </Link>
        </p>
      </Container>
